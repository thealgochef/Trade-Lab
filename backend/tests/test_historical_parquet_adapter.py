...
def test_trades_scan_converts_sc_events_to_domain_events(tmp_path: Path) -> None:
    ...
    _write_table(
        ...
        [
            {
                "ts_event": datetime(2026, 2, 22, 14, 0, tzinfo=UTC),
                "price": 17000.25,
                "size": 2,
                "side": "B",
                "sequence": 1,
            ...
            {
                "ts_event": datetime(2026, 2, 22, 14, 1, tzinfo=UTC),
                "price": 17000.50,
                "size": 3,
                "side": "A",
                "sequence": 2,
            ...
            {
                "ts_event": datetime(2026, 2, 22, 14, 2, tzinfo=UTC),
                "price": 17000.75,
                "size": 1,
                "side": "N",
                "sequence": 3,
...
def test_mbp10_quotes_are_level0_deduped(tmp_path: Path) -> None:
    ...
    _write_table(
        ...
        [
            ...
            {
                "ts_event": base.replace(second=1),
                "action": "A",
                "price": 17000.0,
                "size": 1,
                "side": "B",
            ...
            {
                "ts_event": base.replace(second=2),
                "action": "T",
                "price": 17000.5,
                "size": 2,
                "side": "B",
            ...
            {
                "ts_event": base.replace(second=3),
                "action": "A",
                "price": 17000.25,
                "size": 1,
                "side": "B",
...
def test_naive_timestamp_becomes_domain_invalid_timestamp_warning(tmp_path: Path) -> None:
    ...
    _write_table(
        ...
        [
            {
                "ts_event": datetime(2026, 2, 22, 14, 0),
                "price": 17000.0,
                "size": 1,
                "side": "B",
                "sequence": 1,
...
def test_trading_day_mode_composes_canonical_window(tmp_path: Path) -> None:
    ...
    _write_table(
        ...
        [
            {
                "ts_event": datetime(2026, 2, 17, 22, 0, tzinfo=UTC),
                "price": 16990.0,
                "size": 1,
                "side": "B",
                "sequence": 1,
            ...
            {
                "ts_event": datetime(2026, 2, 17, 23, 30, tzinfo=UTC),
                "price": 16991.0,
                "size": 1,
                "side": "B",
                "sequence": 2,
    ...
    _write_table(
        ...
        [
            {
                "ts_event": datetime(2026, 2, 18, 10, 0, tzinfo=UTC),
                "price": 16992.0,
                "size": 1,
                "side": "B",
                "sequence": 3,
            ...
            {
                "ts_event": datetime(2026, 2, 18, 23, 30, tzinfo=UTC),
                "price": 16993.0,
                "size": 1,
                "side": "B",
                "sequence": 4,
    ...
    _write_table(
        ...
        [
            ...
            },
            {
                ...
                "side": "B",
                "instrument_id": 2,
                "raw_symbol": "NQH6-NQM6",
                "sequence": 3,
            },
            {
                "ts_event": datetime(2026, 2, 22, 14, 3, tzinfo=UTC),
                "price": 17000.50,
                "size": 9,
                "side": "B",
                "instrument_id": 3,
